...
class INA219{
 public:
	...
	void begin(void);
	void setCalibration_32V_2A(void); //Deprecated
	void setCalibration_32V_1A(void); //Deprecated
	void setCalibration_16V_32A(void);
	void setCalibration_16V_400mA(void); //Deprecated
